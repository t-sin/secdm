;; This file is modified version of https://github.com/t-sin/lisc/blob/master/examples/lisc.l
;; In this case, this file is read by Common Lisp reader, so replace `:` with `__`.
                ...
                (if (eq (car form) (quote quote))
                    ...
                    (if (eq (car form) (quote lambda))
                        ...
                        (if (eq (car form) (quote define))
                            ...
                            ((lambda (fn)
                               (if (eq fn (quote __unbound__))
                                   (quote __undefined-op__)
